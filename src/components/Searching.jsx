  ...
  return (
    <form className='search'>
        <div className='flex items-center border-[1px] h-[50px] px-[10px] py-[20px] rounded-full w-[600px] mt-[40px] max-w-2xl'>
          ...
          <input className='flex-1 px-[10px] py-[10px] border-none focus:outline-0' value={input} onChange={e => setInput(e.target.value)}/>
          <Mic/>
        </div>

        {!hideButtons ? (
        <div className='flex mt-[30px] justify-center'>
            <Button className='m-[5px] px-[7px] py-[15px] bg-white border' type='submit' onClick={search} variant="outlined">
                Google Search
            </Button>
        </div>
        ) : (
